...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 5000.0, "minX": 0.0, "maxY": 5000.0, "series": [{"data": [[0.0, 5000.0]], "isOverall": false, "label": "POST 报名", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 4.9E-324, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.77773784E12, "maxY": 1.4876033057851221, "series": [{"data": [[1.7777379E12, 1.000300030002998], [1.77773784E12, 1.4876033057851221], [1.77773796E12, 1.0]], "isOverall": false, "label": "Docker 5000", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.77773796E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 1.6314412238325293, "minX": 1.0, "maxY": 37.61111111111111, "series": [{"data": [[16.0, 3.0], [1.0, 1.6314412238325293], [2.0, 14.0], [25.0, 35.875], [26.0, 37.61111111111111], [27.0, 3.0], [28.0, 4.0], [29.0, 2.0], [30.0, 4.0]], "isOverall": false, "label": "POST 报名", "isController": false}, {"data": [[1.153599999999998, 1.8198000000000039]], "isOverall": false, "label": "POST 报名-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 30.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 385.4, "minX": 1.77773784E12, "maxY": 22664.4, "series": [{"data": [[1.7777379E12, 13665.3], [1.77773784E12, 6449.3], [1.77773796E12, 385.4]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.7777379E12, 22664.4], [1.77773784E12, 10696.4], [1.77773796E12, 639.2]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.77773796E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 1.5616561656165602, "minX": 1.77773784E12, "maxY": 2.3719008264462884, "series": [{"data": [[1.7777379E12, 1.5616561656165602], [1.77773784E12, 2.3719008264462884], [1.77773796E12, 1.7340425531914896]], "isOverall": false, "label": "POST 报名", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77773796E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 1.5565556555655549, "minX": 1.77773784E12, "maxY": 2.3610934520025477, "series": [{"data": [[1.7777379E12, 1.5565556555655549], [1.77773784E12, 2.3610934520025477], [1.77773796E12, 1.7340425531914896]], "isOverall": false, "label": "POST 报名", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77773796E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.2872340425531917, "minX": 1.77773784E12, "maxY": 0.9205340114431031, "series": [{"data": [[1.7777379E12, 0.3030303030303026], [1.77773784E12, 0.9205340114431031], [1.77773796E12, 0.2872340425531917]], "isOverall": false, "label": "POST 报名", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77773796E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.77773784E12, "maxY": 45.0, "series": [{"data": [[1.7777379E12, 14.0], [1.77773784E12, 45.0], [1.77773796E12, 3.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.7777379E12, 1.0], [1.77773784E12, 1.0], [1.77773796E12, 1.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.7777379E12, 2.0], [1.77773784E12, 2.0], [1.77773796E12, 2.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.7777379E12, 3.0], [1.77773784E12, 39.0], [1.77773796E12, 3.0]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.7777379E12, 2.0], [1.77773784E12, 2.0], [1.77773796E12, 2.0]], "isOverall": false, "label": "Median", "isController": false}, {"data": [[1.7777379E12, 2.0], [1.77773784E12, 2.0], [1.77773796E12, 2.0]], "isOverall": false, "label": "95th percentile", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.77773796E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 38.0, "maxY": 2.0, "series": [{"data": [[73.0, 2.0], [38.0, 2.0], [55.0, 2.0], [56.0, 2.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 73.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 38.0, "maxY": 2.0, "series": [{"data": [[73.0, 2.0], [38.0, 2.0], [55.0, 2.0], [56.0, 2.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 73.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 1.5666666666666667, "minX": 1.77773784E12, "maxY": 55.55, "series": [{"data": [[1.7777379E12, 55.55], [1.77773784E12, 26.216666666666665], [1.77773796E12, 1.5666666666666667]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.77773796E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 1.5666666666666667, "minX": 1.77773784E12, "maxY": 55.55, "series": [{"data": [[1.7777379E12, 55.55], [1.77773784E12, 26.216666666666665], [1.77773796E12, 1.5666666666666667]], "isOverall": false, "label": "202", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.77773796E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 1.5666666666666667, "minX": 1.77773784E12, "maxY": 55.55, "series": [{"data": [[1.7777379E12, 55.55], [1.77773784E12, 26.216666666666665], [1.77773796E12, 1.5666666666666667]], "isOverall": false, "label": "POST 报名-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77773796E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 1.5666666666666667, "minX": 1.77773784E12, "maxY": 55.55, "series": [{"data": [[1.7777379E12, 55.55], [1.77773784E12, 26.216666666666665], [1.77773796E12, 1.5666666666666667]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.77773796E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
